...
export default function Subscribe() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    toast.success(`Subscribed successfully! Plan: ${formData.plan}`);
  ...
  return (
    <div className="flex h-screen w-screen bg-gray-50">
      {/* Sidebar */}
      <Sidebar profileName={formData.fullName || "Guest"} />

      <div className="flex flex-col flex-1">
        {/* Topbar */}
        <Topbar profileName={formData.fullName || "Guest"} profilePic="" />
